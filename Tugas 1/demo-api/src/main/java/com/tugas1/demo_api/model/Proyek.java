...
public class Proyek {
    ...
    public Proyek(Long id, String namaProyek, String client, LocalDateTime tglMulai, LocalDateTime tglSelesai,
            String pimpinanProyek, String keterangan, LocalDateTime createdAt, Set<Lokasi> lokasi) {
        this.id = id;
