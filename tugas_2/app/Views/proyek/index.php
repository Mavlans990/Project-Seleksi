    ...
    <body>
        ...
        <div class="container mt-4">
            ...
            <tr>
                ...
                <td><?php echo $p['pimpinan_proyek']; ?></td>
                <td><?php echo $p['keterangan']; ?></td>
                <td>
                    <a href="/proyek/edit/<?php echo $p['id']; ?>" class="btn btn-warning btn-sm">Edit</a>
                    <a href="/proyek/delete/<?php echo $p['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus?')">Hapus</a>
                </td>
            </tr>
            <?php endforeach; ?>
            </table>
